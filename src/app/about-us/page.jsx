...
export default function AbouutUs() {
  return (
    <div className="space-y-12">
      ...
      <section className="flex flex-col md:flex-row gap-4 px-4 lg:px-0 space-y-12">
        <Image
        ...
        <article className="space-y-4">
          ...
          <p className="text-justify leading-8 text-gray">
            ...
            کشلس و عابر بانک های موجود در بازار ، و با بهره مندی از سه شعبه فعال
            در کرمان ، راور و زرند، همچنین چندین نمایندگی در شهرستان های بم ،
